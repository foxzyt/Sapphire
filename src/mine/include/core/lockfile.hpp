#ifndef MINE_LOCKFILE_HPP
#define MINE_LOCKFILE_HPP
...
public:
    LockFile(const fs::path& plugin_dir, const std::string& plugin_name)
        : project_name_(plugin_name), lockfile_path_(plugin_dir / "mine.lock") {}
