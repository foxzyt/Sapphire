#ifndef SPARK_COMMANDS_CACHE_DIR_HPP
#define SPARK_COMMANDS_CACHE_DIR_HPP
...
inline int cmd_cache_dir() {
    ...
    std::cout << termcolor::bold << "Spark Cache Directory" << termcolor::reset << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "Run " << termcolor::green << "spark cache clean" << termcolor::reset
...
#endif // SPARK_COMMANDS_CACHE_DIR_HPP