#ifndef TOPAZ_COMMANDS_LIST_HPP
#define TOPAZ_COMMANDS_LIST_HPP
    ...
    // -----------------------------------------------------------------------
    {
        ...
        if (active_ver.empty()) {
            std::cout << termcolor::yellow
                      << "  Runtime: (not installed — run: topaz sapphire install latest)"
                      << termcolor::reset << std::endl;
        } else {
            std::cout << "  Active:  "
            ...
            if (installed_vers.size() > 1) {
                std::cout << "  ("
                          << installed_vers.size()
                          << " versions installed — run: topaz sapphire versions)";
            }
            std::cout << std::endl;
