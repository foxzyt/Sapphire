#ifndef TOPAZ_LOCKFILE_HPP
#define TOPAZ_LOCKFILE_HPP
...
public:
    LockFile(const fs::path& version_dir, const std::string& plugin_name, const std::string& version)
        : project_name_(plugin_name + "@" + version), lockfile_path_(version_dir / "topaz.lock") {}
    ...
    bool write_checksums_txt() {
        ...
        file << "# Generated by Topaz Package Manager\n\n";
