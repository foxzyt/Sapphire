...
- Integrado o **Citrine**, o **Garnet** e o **Amethyst** no menu de ajuda principal do Sapphire (`sapphire -h` / `display_info()`) sob a seção de ferramentas oficiais (`Tool Options`).
