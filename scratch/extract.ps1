$classes = @("Tensor", "Init", "Neuron", "Linear", "ActivationLayer", "MLP", "Adam", "Softmax", "Tokenizer", "Embedding", "LayerNorm", "MultiHeadAttention", "TransformerBlock", "TransformerLanguageModel", "CrossEntropyLoss", "SequenceCrossEntropyLoss")
